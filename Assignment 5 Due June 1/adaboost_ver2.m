classdef adaboost_ver2
     ...
     label_name(1,:)
         ...
         methods
             function obj = adaboost_ver2(TrainSet, train_label, T)
                 if nargin == 3
             ...
             %output the hypothesis
                    for j = 1:max(size(test_data))
                        ...
                        for i = 1:obj.iter_num
                            ...
                            sum_left = sum_left + log(1/obj.beta_vec(i))*(test_result-min(obj.label_name));
                            sum_right = sum_right + 0.5*log(1/obj.beta_vec(i));
                        end
                        if sum_left >= sum_right
                            test_result_boost(1,j) = 2;
                        else
